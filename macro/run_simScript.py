...
if (simEngine == "Genie" or simEngine == "nuRadiography") and defaultInputFile: 
  inputFile = "/eos/experiment/ship/data/GenieEvents/genie-nu_mu_bar.root"
...
# Genie
 ...
 Geniegen.SetPositions(ship_geo.target.z0, ship_geo.tauMudet.zMudetC - ship_geo.tauMudet.Ztot/2, ship_geo.tauMudet.zMudetC + ship_geo.tauMudet.Ztot/2 + 9.8012)
